 ...
 */
define(['./when-0488ac89', './Check-78ca6843', './Math-a09b4ca4', './Cartesian2-e22df635', './defineProperties-c6a70625', './Transforms-6adeead3', './RuntimeError-4d6e0952', './WebGLConstants-66e14a3b', './ComponentDatatype-9fd090e4', './AttributeCompression-3fc96685', './IntersectionTests-7f177a7d', './Plane-25a88d8d', './WebMercatorProjection-346eec3e', './createTaskProcessorWorker', './EllipsoidTangentPlane-72fadcdc', './OrientedBoundingBox-3264763c', './EllipsoidalOccluder-4a786328', './TerrainEncoding-7daaaa23'], function (when, Check, _Math, Cartesian2, defineProperties, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, AttributeCompression, IntersectionTests, Plane, WebMercatorProjection, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, EllipsoidalOccluder, TerrainEncoding) { 'use strict';
    ...
    /**
        ...
        HeightmapTessellator.computeVertices = function(options) {
            ...
            if (when.defined(rectangle) && rectangle.width < _Math.CesiumMath.PI_OVER_TWO + _Math.CesiumMath.EPSILON5) {
